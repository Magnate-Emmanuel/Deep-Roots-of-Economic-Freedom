...
/* COLUMN 3 */
/* -------- */
eststo col3: reg $ylist $xlist $geor $climate $timedum if smpl_flag1 == 1, vce(cluster cid) noomitted vsquish
*outreg2 using econfree.rtf, append keep(avg_pdiv_aa $geor) ctitle(OLS) 
...
/* COLUMN 4 */
/* -------- */
eststo col4: reg $ylist $xlist $geor $climate $ethfrac $ethpolr $timedum if smpl_flag1 == 1, vce(cluster cid) noomitted vsquish
...
/* COLUMN 5 */
/* -------- */
eststo col5: reg $ylist $xlist $geor $climate $ethfrac $ethpolr $ypercap $popsize $oilprod $timedum if smpl_flag1 == 1, vce(cluster cid) noomitted vsquish
...
/* COLUMN 6 */
/* -------- */
eststo col6: reg $ylist $xlist $geor $climate $ethfrac $ethpolr $ypercap $popsize $oilprod $inst $timedum if smpl_flag1 == 1, vce(cluster cid) noomitted vsquish
...
/* COLUMN 7 */
/* -------- */
eststo col7: reg $ylist $xlist $geor $climate $ethfrac $ethpolr $ypercap $popsize $oilprod $inst $legalor $colhist $timedum if smpl_flag1 == 1, vce(cluster cid) noomitted vsquish
...
/* COLUMN 9 */
/* -------- */
eststo col9: reg $ylist $xlist $geor $climate $ethfrac $ethpolr $ypercap $popsize $oilprod $inst $legalor $colhist $contall $timedum if smpl_flag1 == 1, vce(cluster cid) noomitted vsquish
...
/* COLUMN 11 */
/* --------- */
eststo col11: ivregress 2sls $ylist $geor $climate $timedum ($xlist = $ivlist) if smpl_flag1 == 1, vce(cluster cid) first noomitted vsquish 
...
/* COLUMN 12 */
/* --------- */
eststo col12: ivregress 2sls $ylist $geor $climate $ethfrac $ethpolr $ypercap $popsize $oilprod $inst $legalor $colhist $contall $timedum ($xlist = $ivlist) if smpl_flag2 == 1, vce(cluster cid) first noomitted vsquish
